        ...
        <Reveal className="mt-16 md:mt-20">
          <div className="flex flex-wrap gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2.5 bg-terra-500 text-cream-50 px-7 py-4 text-[0.9rem] font-medium tracking-wide hover:bg-terra-600 transition-colors duration-150"
            >
              Explore PRAXIS
              <svg className="transition-transform duration-150 group-hover:translate-x-1" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
            </a>
            <a
              href={praxis.github}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 text-[0.9rem] text-ink-300 hover:text-terra-500 transition-colors duration-150 font-medium light:text-ink-600"
            >
